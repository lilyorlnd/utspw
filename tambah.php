...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-3" style="background-color:#DBDFEA; padding-bottom:38%;">
            <ul class="list-group">
                <li class="list-group-item text-dark mt-2 mb-2"><a href="#" style="text-decoration:none;color:black;">Dashboard</a></li>
                <li class="list-group-item text-dark mb-2"><a href="#" style="text-decoration:none;color:black;">Mahasiswa</a></li>
        ...
        <div class="col-9">
            <div class="row">
                ...
                <form method="post" action="">
                    ...
                    <div>
                        <button class="btn btn-info text-light mt-3" type="submit" name="txREGISTER" id="register"><b>Tambah</b></button>
                    </div>
                </form>
                </div>
            </div>

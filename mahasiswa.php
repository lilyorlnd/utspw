        ...
        <div class="col-9">
            <div class="row">
                ...
                <div class="col-12 mt-3">
                    <div class="text-center border rounded text-light p-2" style="background-color:light;">
                        <div class="d-flex justify-content-start">
                            <a href="tambah.php" class="btn btn-info text-light">Input Data Mahasiswa</a>
                        </div>
                    </div>
                </div>

    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-center" style="margin-top:10%">
                <form class="border border-dark p-3 " method="post" action="">
                    <div class="bg-body text-center  rounded">
                        <label class="form-label p-2 text-dark fs-4"><b>Sistem Informasi Akademik</b></label>
                    </div>
                    <div class="mb-3 mt-3">
                    ...
                    <p>Belum punya akun? <b><a href="register.php" style="text-decoration:none">Daftar disini</a></b></p>
                </form>
        </div>
    </div>
